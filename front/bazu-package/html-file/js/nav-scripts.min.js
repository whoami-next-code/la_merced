        ...
        a.scroll(function() {
            ...
            a.on("scroll", function() {
                var n = e(".site-contact").outerHeight(!0),
                    ...
                    o = n + s;
                a.width() <= 7500 && (o = i.hasClass("hide-topbar-mobile") ? 0 : s), a.scrollTop() > o ? (t.addClass("minimized"), e("#fh-header-minimized").addClass("minimized")) : (t.removeClass("minimized"), e("#fh-header-minimized").removeClass("minimized"))
            });
            var n;
            if (a.width() < 1200) {
                n = t;
        ...
        e("#off-canvas-layer").on("click", function(e) {
            ...
            function() {
                n.find(".menu .menu-item-has-children").prepend('<span class="toggle-children "><i class="fa fa-angle-right" aria-hidden="true"></i></span>'), n.find(".menu .menu-item-has-children").each(function() {
                    var i = "";
                    e(this).children("a").hasClass("dropdown-toggle") && (i = e(this).children(".dropdown-toggle").html()), e(this).children("ul").prepend('<li class="menu-parent-items">' + i + "</li>"), e(this).children("ul").prepend('<li class="menu-back">' + bazu.bazu_back + "</li>")
